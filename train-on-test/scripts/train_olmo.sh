...
torchrun --nproc_per_node=8 --master_port=29501 scripts/train.py configs/official/OLMo-7B.yaml --load_path="/mnt/qb/luxburg/sbordt10/OLMo-7B-checkpoints/step300000-unsharded/"