...
torchrun --nproc_per_node=4 --master_port=29501 scripts/train.py configs/official/OLMo-7B-step300080-unsharded.yaml --load_path="/weka/luxburg/sbordt10/v1_5-mix-mitch-ish/step302950-unsharded"