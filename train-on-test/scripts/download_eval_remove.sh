...
python download_checkpoint.py --checkpoint_url "https://olmo-checkpoints.org/ai2-llm/olmo-medium/obde4w9j/step310000-unsharded" --output_dir "/mnt/qb/luxburg/sbordt10/OLMo-7B-checkpoints/step310000-unsharded-eval-only"
